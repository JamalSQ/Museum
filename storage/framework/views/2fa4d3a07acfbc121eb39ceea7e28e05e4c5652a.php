<style>
    ...
    .middle-inner .logo-container img {
        max-width: 50%;
    ...
    /* Hide the logo on screens smaller than 768px (typical mobile devices) */
    @media (max-width: 767px) {
        ...
        .logo-container img {
            max-width: 100%;
            /* Set maximum width to 100% of container */
            height: auto;
            /* Maintain aspect ratio */
            width: 50px;
...
<header class="header shop">
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            ...
                            <li><i class="ti-email"></i> info@test.com</li>
                        </ul>
                    </div>
                    <!--/ End Top Left -->
                </div>
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        <ul class="list-main">
                            ...
                            <li><i class="fa fa-download"></i> <a href="<?php echo e(route('downloads')); ?>" target="_blank">Downloads</a></li>
            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo-container">
                        <a href="<?php echo e(route('home')); ?>"><img src="<?php echo e(asset('photos/Logo/logo.png')); ?>" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                    ...
                    <div class="container">
                        <div class="mobile-nav">
                            <!-- Add your mobile navigation markup here -->
                        </div>
                    </div>
                </div>
    ...
    <!--/ End Header Inner -->
</header><?php /**PATH C:\xampp\htdocs\Museum\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>