          ...
          <tbody>
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                <tr>
                    ...
                    <td>
                        <?php if($user->photo): ?>
                            <img src="<?php echo e(asset($user->photo)); ?>" class="img-fluid rounded-circle" style="max-width:50px" alt="<?php echo e($user->photo); ?>">
                        <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cosmose\resources\views/backend/users/index.blade.php ENDPATH**/ ?>