                    ...
                    <td>
                        <?php if($product->photo): ?>
                            <?php
                              ...
                              // dd($photo);
                            ?>
                            <img src="<?php echo e(asset($photo[0])); ?>" class="img-fluid zoom" style="max-width:80px" alt="<?php echo e($product->photo); ?>">
                        <?php else: ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\Cosmose\resources\views/backend/product/index.blade.php ENDPATH**/ ?>