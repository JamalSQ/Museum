            ...
            ?> 
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="<?php echo e(route('order.destroy',[$order->id])); ?>"  enctype="multipart/form-data">
                          <?php echo csrf_field(); ?> 
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cosmose\resources\views/backend/order/index.blade.php ENDPATH**/ ?>