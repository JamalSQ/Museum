<?php $__env->startSection('title','Cosmose || HOME PAGE'); ?>
    ...
    <section id="Gslider" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item <?php echo e((($key==0)? 'active' : '')); ?>">
                    <img class="first-slide" src="<?php echo e(asset($banner->photo)); ?>" alt="First slide">
                ...
                <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="shop-single-blog">
                            <img src="<?php echo e(asset($post->photo)); ?>" alt="<?php echo e($post->photo); ?>">
                            <div class="content">
...
function verifyAge() {
  Swal.fire({
    ...
    iconHtml: '<img src="<?php echo e(asset('photos/Logo/logo.png')); ?>" alt="Logo" style="width: 100px; height: auto;">',
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cosmose\resources\views/frontend/index.blade.php ENDPATH**/ ?>