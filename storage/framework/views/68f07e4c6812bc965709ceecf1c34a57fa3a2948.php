...
<section class="shop checkout section">
    <div class="container">
        <form class="form" method="POST" action="<?php echo e(route('cart.order')); ?>">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="shipping" id="hiddenShipping" value="<?php echo e($shipselect); ?>">
                            ...
                            <div class="content">
                                <ul>
                                    <li class="order_subtotal" data-price="<?php echo e(Helper::totalCartPrice()); ?>">
                                        Cart Subtotal<span>$<?php echo e(number_format(Helper::totalCartPrice(),2)); ?></span>
                                    </li>

                                    <li class="shipping">
                                        Shipping Cost
                                        <?php if(count(Helper::shipping()) > 0 && Helper::cartCount() > 0): ?>
                                        <select name="shipping" class="nice-select" disabled>
                                            <option value="">Select Your Shipping Type</option>
                                            ...
                                            <option value="<?php echo e($shipping->id); ?>"
                                                ...
                                                <?php if($shipselect==$shipping->id): ?> selected <?php endif; ?>>
                                                <?php echo e($shipping->type); ?>: $<?php echo e($shipping->price); ?>
                                    ...
                                    <li class="coupon_price" data-price="<?php echo e(session('coupon')['value']); ?>">
                                        You Save<span>$<?php echo e(number_format(session('coupon')['value'],2)); ?></span>
                                    </li>
                                    <?php endif; ?>
                                    ...
                                    <li class="last" id="order_total_price">
                                        Total<span>$<?php echo e(number_format($total_amount,2)); ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        // Trigger the update when the page loads (for already selected shipping method)
        updateTotalPrice();

        // When the shipping method is selected or changed
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Museum\resources\views/frontend/pages/checkout.blade.php ENDPATH**/ ?>