...
<div class="card shadow mb-4">
   ...
   <div class="card-body">
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        ...
                        <img class="card-img-top img-fluid roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="<?php echo e(asset($profile->photo)); ?>" alt="profile picture">
                        <?php else: ?> 
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="<?php echo e(route('profile-update',$profile->id)); ?>"  enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\Cosmose\resources\views/backend/users/profile.blade.php ENDPATH**/ ?>