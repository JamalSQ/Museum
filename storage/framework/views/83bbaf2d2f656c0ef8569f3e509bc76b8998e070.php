...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-group d-none" id="mainfile_div">
        <label for="price" class="col-form-label">Zip File <span class="text-danger">*</span></label>
        <input type="file" name="mainfile" id="mainfile" class="form-control" accept=".zip,.rar" required>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Museum\resources\views/backend/product/create.blade.php ENDPATH**/ ?>