<?php $__env->startSection('title','Cosmose World || About Us'); ?>
				...
				<div class="row">
					<div class="col-lg-6 col-12">
						<div class="about-content">
							...
							?>
							<h3>Welcome To <span>Cosmose World</span></h3>
					...
					<div class="col-lg-6 col-12">
						<div class="about-img overlay">
							...
							<img src="<?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e(asset($data->photo)); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>" alt="<?php $__currentLoopData = $settings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($data->photo); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>">
						</div>
					</div>
				</div>
			</div>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Cosmose\resources\views/frontend/pages/about-us.blade.php ENDPATH**/ ?>