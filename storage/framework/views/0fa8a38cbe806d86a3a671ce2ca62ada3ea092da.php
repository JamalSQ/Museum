                ...
                <tr>
                    ...
                    <td>
                        <?php if($category->photo): ?>
                            <img src="<?php echo e(asset($category->photo)); ?>" class="img-fluid" style="max-width:80px" alt="<?php echo e($category->photo); ?>">
                        <?php else: ?>
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Xampp\htdocs\Cosmose\resources\views/backend/category/index.blade.php ENDPATH**/ ?>