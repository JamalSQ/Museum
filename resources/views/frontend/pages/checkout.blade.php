...
<section class="shop checkout section">
    <div class="container">
        <form class="form" method="POST" action="{{route('cart.order')}}">
            @csrf
            <input type="hidden" name="shipping" id="hiddenShipping" value="{{ $shipselect }}">
                            ...
                            <div class="content">
                                <ul>
                                    ...
                                    <li class="shipping">
                                        ...
                                        <select name="shipping" class="nice-select" disabled>
                                            ...
                                            <option value="{{$shipping->id}}"
                                                ...
                                                @if($shipselect==$shipping->id) selected @endif>
                                    ...
                                    <li class="coupon_price" data-price="{{session('coupon')['value']}}">
                                        You Save<span>${{number_format(session('coupon')['value'],2)}}</span>
                                    </li>
                                    @endif
